...
class AlamofireRequestWithObjectMapperViewController: UIViewController {
    
    override func viewDidAppear(_ animated: Bool) {
        self.navigationController?.navigationBar.topItem?.title = "Alamofire Request With Object Mapper"
    }
